...
func main(){
	...
	fmt.Println("ReceiptHash: ",block.ReceiptHash())
	...
	fmt.Println("Txs: ",block.Transactions()[0])
...
/*
	...
	caps := make([]p2p.Cap,1)
	var caps1 = caps{cap}
	var nodeid = [4]byte{12,13,14,15}
	peer:=p2p.NewPeer(nodeid,"lidian",caps1)
	peer1:=eth.newPeer(100,peer,) 
*/
}
