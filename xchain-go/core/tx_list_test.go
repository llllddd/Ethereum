...
var (
	tx_0 = basic.NewTransaction(big.NewInt(1537926486), common.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d8"), big.NewInt(0), []byte{})

	tx_1 = basic.NewTransaction(big.NewInt(1537926486), common.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d8"), big.NewInt(0), []byte{})

	tx_2 = basic.NewTransaction(big.NewInt(1537926488), common.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d8"), big.NewInt(0), []byte{})

	tx_3 = basic.NewTransaction(big.NewInt(1537926489), common.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d8"), big.NewInt(0), []byte{})
)
